...
//    console.dir("beforeInit");
  ...
  this.listen = function () {
    ...
    // autocomplete 한글 사용으로 comment 처리함 [16.12.01]
    /*
...
//    console.dir("beginEditing start");
...
Handsontable.cellTypes = {
  ...
  textCenter: Handsontable.TextCell,
  textHyperLink: Handsontable.TextCell,
  htTextHyperLinkLeftAlign: Handsontable.TextCell,
  vssNmRender: Handsontable.TextCell,
  date: Handsontable.DateCell,
  numeric: Handsontable.NumericCell,
  checkbox: Handsontable.CheckboxCell,
  autocomplete: Handsontable.AutocompleteCell,
  autocompleteCenter: Handsontable.AutocompleteCell,
  ...
  var bindMoveColEvents = function () {
    ...
    instance.rootElement.on('mouseup.manualColumnMove', function () {
      if (pressed) {
        ...
        pressed = false;
        instance.forceFullRender = true;
//        console.dir("mouseup.manualColumnMove");
      ...
      if (autoresizeTimeout == null) {
        autoresizeTimeout = setTimeout(function () {
          if (dblclick >= 2) {
            ...
            instance.forceFullRender = true;
//            console.dir("mousedown.handsontable, manualColumnResizer");
            instance.view.render(); //updates all
            instance.PluginHooks.run('afterColumnResize', currentCol, newSize);
          }
          dblclick = 0;
...
//        console.dir("instance.observeChangesActive");
        instance.render();
      }
...
//    console.dir("iRemoveRowAction afterRender");
    instance.render();
  };
  ...
  Handsontable.UndoRedo.RemoveColumnAction.prototype.undo = function (instance, undoneCallback) {
    ...
    instance.addHookOnce('afterRender', undoneCallback);
//    console.dir("RemoveColumnAction afterRender");
    instance.render();
  };
...
WalkontableTable.prototype.adjustAvailableNodes = function () {
  ...
  for (c = 0; c < displayTds; c++) {
    if (columnHeaders.length) {
      var temp = (this.columnFilter.visibleToSource(c), TR.childNodes[displayThs + c]);
      if(temp.children[0] != undefined && temp.children[0].children[0] != undefined &&
			  temp.children[0].children[0].children[0] != undefined && 
			  temp.children[0].children[0].children[0].checked != undefined) {
      } else {
